            ...
            <!-- firstName control -->
                                                <c:if test="${empty form.erreurs.firstName }">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="firstName" placeholder="Prénom" class="form-control" value='<jsp:getProperty property="firstName" name="user"/>'>
                                                    </div>
                                                </c:if>
                                                <c:if test="${!empty form.erreurs.firstName }">
                                                    <div class="form-group">
                                                        <label for="firstName" class="text-danger">Prénom</label>
                                                        <input type="text" name="firstName" placeholder="Prénom"  class="form-control is-invalid"value='<jsp:getProperty property="firstName" name="user"/>'>
